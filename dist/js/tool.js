...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        toggle: function toggle() {
            ...
            this.sidebarLinks = document.querySelectorAll(".w-sidebar a, .w-sidebar .cursor-pointer:not(.nc-head), .w-sidebar .nc-item-link");
        },
    ...
    [
      _c(
        "h3",
        {
          ...
          staticClass:
            "flex items-center font-normal text-white mb-6 text-base no-underline cursor-pointer nova-category-toggler nc-head",
          on: {
        ...
        [
          ...
          _vm._v(" "),
          _c("span", { staticClass: "nc-label" }, [_vm._v(_vm._s(_vm.header))]),
          _vm._v(" "),
          _vm.expanded
            ? [
                _c("span", { staticClass: "nc-toggle toggle-button" }, [
                  _vm._v("−")
                ])
              ]
            : [
      ...
      _c(
        "transition-group",
        {
          staticClass: "list-reset nc-list",
          class: { "mb-6": _vm.last },
          attrs: { tag: "ul" }
        },
